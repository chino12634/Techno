            ...
            <div class="card card-default">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6"><label>Subtotal: <span class="text-muted">₱{{ $orderDetail->subtotal }}</span></label></div>
                            <div class="col-6"><label>Order date: <span class="text-muted">{{ $orderDetail->created_at }}</span></label></div>
                            <div class="col-6"><label>Discount: <span class="text-muted">₱{{ $orderDetail->discountTotal() }}</span></label></div>
                            <div class="col-6"><label>Payment: <span class="text-muted">{{ $orderDetail->payment()->first()->name }}</span></label></div>
                            <div class="col-6"><label>Total: <span class="text-muted">₱{{ $orderDetail->total }}</span></label></div>
